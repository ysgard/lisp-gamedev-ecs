...
!define MUI_PRODUCT "ECS Tutorial for Lisp Gamedev"
!define MUI_FILE "ecs-tutorial"
...
Name "ECS Tutorial for Lisp Gamedev"
OutFile "../ecs-tutorial-${MUI_VERSION}-setup.exe"
